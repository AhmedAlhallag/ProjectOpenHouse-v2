...
<?php  if ($type != 'admin'){ ?>
    ...
    <div class="nav-wrapper #ef6c00 orange darken-3">
      <div class="col s12">
        ...
        <?php } ?>
        <a aria-current="page" class="breadcrumb">Enrolled Students List</a>
      </div>
    </div>
  </nav>
...
<div class="row">
        <h2 class="header">Enrolled Student List</h2>    
			<table id="view_enrolled" class="responsive-table centered">
				<thead>
					<tr>
                    <th>Username</th>
						<th>Email</th>
