...
?>
    ...
    <form id="admin_register_form" method="post" action="">
    ...
    <label for="confirm_admin_pass">Confirm Password: </label>
    <input type="password" name="comfirm_admin_pass" id="comfirm_admin_pass">
    <div class="pass"> 
    <p style="color:red"></p>
    </div>
    ...
    <br><br>
    <input class="btn teal"type="submit" id="admin_register" name="admin_register" value="Register">
